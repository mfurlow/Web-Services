...
namespace Eventtual_Event_Finder
{
    ...
    public partial class EventFinderDB_DEVEntities : DbContext
    {
        ...
        public virtual ObjectResult<spCreateEvent_Result> spCreateEvent(Nullable<System.DateTime> eventStartTime, Nullable<System.DateTime> eventEndTime, string eventTitle, Nullable<decimal> eventPrice, string eventDescription, string eventImageURL, Nullable<int> organizerID, string locationStreet1, string locationStreet2, string locationZipcode, string locationCity, string stateAbbreviation, string countryAbbreviation, string locationBuildingName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spCreateEvent_Result>("spCreateEvent", eventStartTimeParameter, eventEndTimeParameter, eventTitleParameter, eventPriceParameter, eventDescriptionParameter, eventImageURLParameter, organizerIDParameter, locationStreet1Parameter, locationStreet2Parameter, locationZipcodeParameter, locationCityParameter, stateAbbreviationParameter, countryAbbreviationParameter, locationBuildingNameParameter);
        }
